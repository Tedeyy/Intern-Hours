<div class="auth-container">
    <div class="auth-box">
        ...
        <form id="login-form" action="../api/login.php" method="POST">
            ...
            <div id="login-message" class="validation-message"></div>
            <div id="attempts-message" class="validation-message"></div>
        </form>
...
// Removed automatic status check - only show messages after form submission
// checkLoginStatus();
